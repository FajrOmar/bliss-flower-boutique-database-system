...
GRANT CONNECT,RESOURCE TO MANAGER_ROLE;
...
--- Join Optimization---
/*This SQL query retrieves a list of customers' first and last names,
along with the order ID and product type, for all orders that contain the product "Tulip Arrangement." */

SELECT c.First_N, c.Last_N, o.Order_ID, p.Product_Type
FROM Customer c, Order_ o, Order_Product op, Product p
WHERE c.Customer_ID = o.Customer_ID
  AND o.Order_ID = op.Order_ID
  AND op.Product_ID = p.Product_ID
  AND p.Product_Type = 'Tulip Arrangement';
...
WHERE table_name = 'ORDER_';
  --RUN
INSERT INTO Order_ (Order_ID, Order_Date) 
VALUES ('015',  TO_DATE('2025-04-11', 'YYYY-MM-DD'));
  --CHECK
